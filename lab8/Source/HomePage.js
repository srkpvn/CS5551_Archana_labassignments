angular.module('MyModule',[])
    .controller('MyController', function ($scope,$http) {
        ...
        $scope.retrieveData = function (){
            ...
            $scope.query=query;
            var resp=$http.get("https://api.foursquare.com/v2/venues/search?ll=39.0997,-94.5783&query="+query+"&limit=6&client_id=RPCLY5C5TUHTG3T2AKEPZKEEHKNAZE2J32E0NXX33XBNKSWD&client_secret=BHNJJEU1UC5V2ZA5SA2Q4GFO5EFSYPF4YMR1VXXHI10RC2FL&v=20160215");
        ...
        $scope.calcWeather = function (){
            ...
            var resp=$http.get("http://api.openweathermap.org/data/2.5/weather?q=kansas city&units=imperial&appid=00e1b1eae0224cfa0d315c15c437bc40");
            resp.success(function(data,status, headers,config){
